*Some updates and fixes from the original [selectivizr](https://github.com/keithclark/selectivizr) and [selectivizr2](https://github.com/corysimmons/selectivizr2).*   
